...
import 'package:fmtmimi/util/date_converter.dart';
import 'package:fmtmimi/models/response/coupon_list_rp.dart';
  ...
  Future<void> applyCoupon(BuildContext context,
    ...
    if (response.statusCode == 200) {
      ...
      if (body.isEmpty) {
        ...
        update();
        showCustomSnackBar('Coupon code is invalid!');
      } else {
          ...
          if (applyCouponList[0].dateExpires == null) {
            if (applyCouponList[0].usageLimitPerUser == null) {
              ...
              if (getUserUseCount(applyCouponList[0]) <=
                ...
                showCustomSnackBar('Limit expired this Coupon');
              }
            }
          } else {
            ...
            if (isExpired) {
              showCustomSnackBar('Date expired this Coupon!');
            } else {
              if (applyCouponList[0].usageLimitPerUser == null) {
                applyCouponUpdateDiscount(
                    applyCouponList[0], totalPrice, quantity, code);
