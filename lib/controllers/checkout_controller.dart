...
import 'package:fmtmimi/models/body/create_order.dart';
import 'package:fmtmimi/models/response/cart_model.dart';
import 'package:fmtmimi/models/response/shipping_method_list.dart';
import 'package:fmtmimi/models/response/shipping_zone_list.dart';
import 'package:fmtmimi/services/api/api_checker.dart';
  ...
  Future<void> createOrderFromServer(
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      if (_paymentMethod == 'cod' || _paymentMethod == 'bacs') {
        ...
        /*
        showCustomSnackBar('Your order place Successfully. Please payment process complete then exit app.', isError: false);
