...
import 'package:fmtmimi/models/response/address_book.dart';
import 'package:fmtmimi/models/response/cart_model.dart';
import 'package:fmtmimi/view/screens/checkout/widgets/address_view.dart';
                          ...
                          onPress: () {
                            if (addressController.isCheckout ||
                              ...
                              checkoutController.createOrderFromServer(context,
                                  ...
                                  totalPrice:
                                      '${((widget.totalPrice + checkoutController.shippingFee) - (checkoutController.discountPrice))}',
                                  subtotal: widget.totalPrice.toString(),
                                  setPaid:
                                      checkoutController.paymentMethod == 'bacs'
                                          ? true
                                          : false);
                            } else {
                              showCustomSnackBar(
