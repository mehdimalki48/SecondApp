...
import 'package:fmtmimi/models/response/product_list.dart' as model;
        ...
        Stack(
          ...
          children: [
            ...
            Positioned(
              bottom: 10,
              left: 10,
              child: (widget.product?.images?.length ?? 0) > 1
                  ? Container(
                ...
                builder: (favoriteController) {
                  return Container(
                    ...
                    child: LikeButton(
                      ...
                      isLiked:
                          favoriteController.isAlreadyAdd(widget.product!.id!),
