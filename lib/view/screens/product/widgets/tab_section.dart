...
import 'package:fmtmimi/constants/colors_data.dart';
...
import 'package:fmtmimi/models/product_details_overview_data.dart';
import 'package:fmtmimi/models/response/product_list.dart';
import 'package:fmtmimi/view/screens/product/widgets/review_widget.dart';
import 'package:fmtmimi/view/screens/review/review_product_screen.dart';
      ...
      return Container(
        child: index == 0
            ...
            : index == 1
                ...
                : index == 2
                    ? buildReviews(context, productData, reviewController)
                    : RelatedProducts(
                        catId: (productData.categories?.length ?? 0) > 0
      ...
      Container(
        ...
        child: Column(
          children: [
            Row(
              children: [
                ...
                if (productData.regularPrice != "" &&
                    double.parse(productData.regularPrice ?? '0') >
                ...
                InkWell(
                  onTap: () {
                    OthersMethod.sharePost(
                        ...
                        subTitle: '| ${productData.permalink ?? ''}');
                  },
                  child: Container(
                    width: 30,
                    height: 30,
            ...
            kHeightBox10,
            Text(
              productData.name?.replaceAll(htmlValidatorRegExp, '') ?? '',
            ...
            Row(
              children: [
                ...
                kWidthBox5,
                RatingBarIndicator(
                  rating: double.parse(productData.averageRating ?? '0.0'),
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      TextSpan(
                        text: '${productData.ratingCount} ' + 'Reviews'.tr,
                        style: kDescriptionText.copyWith(
                          color: Get.isDarkMode
                              ? kWhiteColor
                ...
                RichText(
                  text: TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text: ' $kCurrency${productController.shippingFee}',
                              ...
                              onTap: () async {
                                if (productData.manageStock ?? false) {
                                  ...
                                  cart.cartView(
                                    context: context,
                                    isCartBuy: true,
                                    productDetailsController: productData,
                                  );
                                } else {
                                  showCustomSnackBar(
      ...
      Container(
        ...
        child: Column(
          ...
          children: [
            ...
            kHeightBox10,
            Text(
              productData.description?.replaceAll(htmlValidatorRegExp, '') ??
                  '',
              style: kRegularText2.copyWith(
                color: Get.isDarkMode ? kWhiteColor : const Color(0xFF303030),
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Divider(
                    ...
                    height: .3,
                    color:
                        Get.isDarkMode ? kBlackColor2 : const Color(0xFF808080),
                  ),
                  kHeightBox10,
                  Text(
                    productController.specification
                      ...
                      if (reviewController.reviewList.isNotEmpty) {
                        Get.to(
                          () => ReviewProductsScreen(
                            rating: productData.averageRating.toString(),
                          ),
                        );
                      }
                    },
