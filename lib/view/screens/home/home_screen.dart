...
import 'package:fmtmimi/util/md2_indicator.dart';
import 'package:fmtmimi/view/screens/search/search_home_screen.dart';
...
class YourPageState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    final newVersion = NewVersion(
      iOSId: 'com.akaarit.fmtmimi',
      androidId: 'com.akaarit.fmtmimi',
    );
...
// The promptForPushNotificationsWithUserResponse function will show the iOS push notification prompt. We recommend removing the following code and instead using an In-App Message to prompt for notification permission
  ...
  Future<void> _loadData(bool reload) async {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      Get.find<HomeController>().fetchBrandList(
        '1',
        reload,
      );
                              ...
                              child: isImageShow
                                  ? ClipRRect(
                                      ...
                                      /*
                                       CachedNetworkImage(
                                        imageUrl:
                                            'https://fmtmimi.com/wp-content/uploads/2022/11/slider1mini.png',
                                        fit: BoxFit.cover,
